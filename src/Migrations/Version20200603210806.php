 ...
 */
final class Version20200603210806 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE project (id INT NOT NULL, users_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, introduction TEXT NOT NULL, content_1 TEXT NOT NULL, content_2 TEXT NOT NULL, content_3 TEXT NOT NULL, main_image VARCHAR(255) NOT NULL, created_at VARCHAR(255) NOT NULL, slug VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE article_field (article_id INT NOT NULL, field_id INT NOT NULL, PRIMARY KEY(article_id, field_id))');
        $this->addSql('CREATE INDEX IDX_2C4237497294869C ON article_field (article_id)');
        $this->addSql('CREATE INDEX IDX_2C423749443707B0 ON article_field (field_id)');
        ...
        $this->addSql('ALTER TABLE article_field ADD CONSTRAINT FK_2C4237497294869C FOREIGN KEY (article_id) REFERENCES article (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE article_field ADD CONSTRAINT FK_2C423749443707B0 FOREIGN KEY (field_id) REFERENCES field (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article_field DROP CONSTRAINT FK_2C423749443707B0');
        ...
        $this->addSql('ALTER TABLE article_field DROP CONSTRAINT FK_2C4237497294869C');
        ...
        $this->addSql('DROP TABLE article_field');
