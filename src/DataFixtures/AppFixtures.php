    ...
    public function load(ObjectManager $manager)
    {
        ...
        $content10 = <<<EOT
            <div class="article__content">
                ...
                <img class="w-50 img-fluid" src="https://slashflex.io/uploads/images/apache_default.webp">
                ...
                <p class="language-html">Inside, add the following sample HTML:</p>
                <img class="img-fluid" src="https://slashflex.io/uploads/images/index-html.webp">
                <p class="language-html">Save and close the file when you are finished.</p>
                ...
                <p class="language-html">Paste in the following configuration block, which is similar to the default, but updated for our new directory and domain name:</p>
                <img class="img-fluid" src="https://slashflex.io/uploads/images/v-host.webp">
                ...
                <img class="img-fluid" src="https://slashflex.io/uploads/images/success-v-host.webp">
                <hr class="separator">
